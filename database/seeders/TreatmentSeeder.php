    ...
    public function run(): void
    {
        $treatments = [
            ...
            [
                ...
                'long_description' => '<p>Liver and metabolic disorders — including fatty liver, elevated enzymes, obesity, and insulin resistance — are increasingly common and deeply linked to lifestyle.</p><p>At Tripti Hotel, we address these conditions through Ayurveda, nutrition counselling, detox support, and activity planning — treating the root metabolic imbalance.</p>',
                'sort_order' => 3,
                'display_on_home' => true,
            ],
            [
