...
@section('content')
    <div class="row"><div class="col-sm-12"><div class="page-title-box"><h4 class="page-title">Add Bed Type</h4></div></div></div>
    <div class="row"><div class="col-lg-8"><div class="card"><div class="card-body">
        <form action="{{ route('admin.bed-types.store') }}" method="POST">
            ...
            <div class="mt-3 admin-form-actions">
                <button type="submit" class="btn btn-primary">Save Bed Type</button>
