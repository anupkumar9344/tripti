@php
    ...
    if ($errors->hasAny(['email_1', 'email_2', 'phone_1', 'phone_2', 'whatsapp_number', 'address', 'opening_hours'])) {
        $activeTab = 'contact';
    } elseif ($errors->hasAny(['visit_us_eyebrow', 'visit_us_title', 'visit_us_description', 'visit_us_bg_image', 'career_page_eyebrow', 'career_page_title', 'career_page_intro', 'career_form_title', 'career_form_description', 'contact_locations_title', 'contact_locations_description', 'contact_form_title', 'contact_form_description'])) {
        $activeTab = 'pages';
