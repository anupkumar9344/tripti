...
class AdminPermissions
{
    ...
    public static function sections(): array
    {
        return [
            ...
            'Team' => [
                'experts.view' => 'View team members',
                'experts.create' => 'Add team members',
                'experts.edit' => 'Edit team members',
                'experts.delete' => 'Delete team members',
            ],
            'Feedback' => [
    ...
    public static function permissionForRoute(?string $routeName): ?string
    {
        ...
        $map = [
            ...
            'admin.experts.index' => 'experts.view',
            'admin.experts.create' => 'experts.create',
            'admin.experts.store' => 'experts.create',
            'admin.experts.edit' => 'experts.edit',
            'admin.experts.update' => 'experts.edit',
            'admin.experts.destroy' => 'experts.delete',
