...
class AdminPermissions
{
    ...
    public static function sections(): array
    {
        return [
            ...
            'Banquet & Meetings' => [
                'event-bookings.view' => 'View event bookings',
                'event-bookings.create' => 'Add event bookings',
                'event-bookings.edit' => 'Edit event bookings',
                'event-bookings.delete' => 'Delete event bookings',
                'event-bookings.update-status' => 'Update event booking status',
            ],
            'Hotel Amenities' => [
            ...
            'Promo Codes' => [
                'promo-codes.view' => 'View promo codes',
                'promo-codes.create' => 'Add promo codes',
                'promo-codes.edit' => 'Edit promo codes',
                'promo-codes.delete' => 'Delete promo codes',
            ],
            'Premium Services' => [
    ...
    public static function permissionForRoute(?string $routeName): ?string
    {
        ...
        $map = [
            ...
            'admin.event-bookings.index' => 'event-bookings.view',
            'admin.event-bookings.create' => 'event-bookings.create',
            'admin.event-bookings.store' => 'event-bookings.create',
            'admin.event-bookings.show' => 'event-bookings.view',
            'admin.event-bookings.edit' => 'event-bookings.edit',
            'admin.event-bookings.update' => 'event-bookings.edit',
            'admin.event-bookings.destroy' => 'event-bookings.delete',
            'admin.event-bookings.update-status' => 'event-bookings.update-status',
            ...
            'admin.promo-codes.index' => 'promo-codes.view',
            'admin.promo-codes.create' => 'promo-codes.create',
            'admin.promo-codes.store' => 'promo-codes.create',
            'admin.promo-codes.edit' => 'promo-codes.edit',
            'admin.promo-codes.update' => 'promo-codes.edit',
            'admin.promo-codes.destroy' => 'promo-codes.delete',
