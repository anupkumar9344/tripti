...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin.auth')->group(function () {
        ...
        Route::resource('room-types.rooms', RoomController::class)->except(['show'])->scoped(['room' => 'roomType']);
        Route::patch('room-types/{room_type}/rooms/{room}/toggle-status', [RoomController::class, 'toggleStatus'])->name('room-types.rooms.toggle-status');
